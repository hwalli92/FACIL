...
dataset_config = {
    ...
    'ntu': {
        'path': join('./', 'CTR-GCN/data/ntu/NTU60_CS_nt.npz'),
        'class_order': None
#            2, 18, 0, 1, 3, 4, 5, 6, 7, 8, 15, 19, 9, 14, 10, 11, 12, 13, 16, 17]
#            2, 18, 0, 3, 4, 5, 1, 6, 7, 8, 15, 19, 9, 14, 10, 11, 12, 13, 16, 17]
#            2, 18, 0, 1, 3, 4, 5, 6, 7, 8, 19, 9, 15, 14, 10, 11, 12, 13, 16, 17],
    },
}
